...
const placeholderProducts = [
  {
    id: "1",
    slug: "product-1",
    name: "เสื้อยืดโลโก้ Classic",
    brand: "Brand A",
    price: 1200,
    imageUrl: "https://via.placeholder.com/300x400.png?text=Product+1",
  },
  {
    id: "2",
    slug: "product-2",
  ...
  },
  {
    id: "4",
    slug: "product-4",
    name: "เสื้อยืดรุ่น Limited",
    brand: "Brand D",
    price: 2500,
    imageUrl: "https://via.placeholder.com/300x400.png?text=Product+4",
  },
];
